...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelReservation.Models.HotelLocation", b =>
                {
                    b.Property<int>("HotelLocationId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HotelReservation.Models.HotelType", b =>
                {
                    b.Property<int>("HotelTypeId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("HotelReservation.Models.Hotel", b =>
                {
                    b.HasOne("HotelReservation.Models.HotelLocation", "HotelLocation")
                        .WithMany()
                        .HasForeignKey("HotelLocationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("HotelReservation.Models.HotelType", "HotelType")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelReservation.Data.ApplicationUser")
                        .WithMany()
